...
describe("Database Utils", () => {
  ...
  describe("withDatabase", () => {
    ...
    it("should log successful operations", async () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith(expect.stringMatching(/Database operation completed successfully in \d+ms/));
    ...
    it("should log failed operations", async () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith(expect.stringMatching(/Database operation failed after \d+ms:/), expect.any(Error));
      consoleSpy.mockRestore();
    });
