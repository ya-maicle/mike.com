...
describe("Database Tools", () => {
  ...
  describe("registerDatabaseTools", () => {
    it("should register listTables and queryDatabase for regular users", () => {
      ...
      expect(toolSpy).toHaveBeenCalledWith("listTables", expect.any(String), expect.any(Object), expect.any(Function));
      expect(toolSpy).toHaveBeenCalledWith("queryDatabase", expect.any(String), expect.any(Object), expect.any(Function));
    ...
    it("should register all tools for privileged users", () => {
      ...
      expect(toolSpy).toHaveBeenCalledWith("listTables", expect.any(String), expect.any(Object), expect.any(Function));
      expect(toolSpy).toHaveBeenCalledWith("queryDatabase", expect.any(String), expect.any(Object), expect.any(Function));
      expect(toolSpy).toHaveBeenCalledWith("executeDatabase", expect.any(String), expect.any(Object), expect.any(Function));
